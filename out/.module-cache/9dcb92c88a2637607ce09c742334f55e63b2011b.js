	...
	'week2' : {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"MP3 was created with a purpose: to shrink a CD quality recording 10 fold while still maintaining an acceptable listening quality. Unfortunately for the artist, and especially the sound engineer, this process trims a good bit of a recordings quality. MP3s encoded with a bit rate of under 256kbps can't even express the full bandwidth of the audible spectrum."
				)
