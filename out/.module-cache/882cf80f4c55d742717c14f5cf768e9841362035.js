	...
	render: function() {
		return (
			...
			React.DOM.h2( {className:"ui header"}, React.DOM.i( {className:"coffee icon"}),"The EP"),
				...
				React.DOM.p(null, 
					" Writing and producing an EP in 7 weeks certainly isn't easy, but it's been done by many before. One band, ", React.DOM.span( {className:"emphasis"}, "Explosions in The Sky"),", produced and composed a full length album in ", React.DOM.a( {target:"_blank", href:"http://www.explosionsinthesky.com/discography/6"}, "two weeks"),", using no existing material. With the gained reassurance from their feat, I drew up a ", React.DOM.a( {target:"_blank", href:"https://docs.google.com/spreadsheet/ccc?key=0AsqPkKbbLFV_dHJiY2RWdERaQXRkeGhQS2xGMWlidkEundefinedg"}, "time line"), " for the next 7 weeks. I'm adopting a waterfall like schedule which I feel is fairly straight forward. ",
			...
			React.DOM.h2( {className:"ui header"}, React.DOM.i( {className:"coffee icon"}),"Reference Tracks"),
				...
				React.DOM.p(null, 
					" What I like about this track is that the acoustic has both a refined, but lightweight sound to it. It obviously wasn't terribly over engineered with reverb effects. I tend to prefer more honest recordings that sounds good, but don't try to reinvent the wheel. ", React.DOM.span( {className:"emphasis"}, "Toe"), " also does a great job of this on some of there more tranquil acoustic songs. This " 
				),
...
React.renderComponent(week1(null),document.getElementById('1'));