	...
	'week2' : {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"After a few hours in the studio, I tracked the guitar line for my first piece, which I had written a while back. It doesn't diverge much from what you heard in the vocal demo, but its obviously more distinguishable. Once I can get Yubs into the studio with me, we'll record his vocals and the track will be ready to master. I plan to hopefully finish this over the next weekend."
				),
