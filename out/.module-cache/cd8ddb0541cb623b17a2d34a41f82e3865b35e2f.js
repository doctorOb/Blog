	...
	'week2' : {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"The amount of raw data stored to CDs allows for a near perfect recreation of the original material. Uncompressed audio formats such as FLAC and WAV make use of nearly all this data, resulting in a less then favorable file size. "
				)
