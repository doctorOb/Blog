...
(function($){
	$(document).ready(function(){
		...
		React.renderComponent(Blog( {body:articles['2'], title:"Week 1 - An Introduction to Production &amp; a Bit About Me "}),document.getElementById('2'));
		React.renderComponent(Blog( {body:articles['1']} ), document.getElementById('1'));
