	...
	'week2' : {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"Lossy audio encoders aim to strip away undetectable components of a track. It works by dividing the music into a number of small frequency sub bands within the 20hz-20khz range, then examining each band and throwing away any data deemed imperceivable."
				)
