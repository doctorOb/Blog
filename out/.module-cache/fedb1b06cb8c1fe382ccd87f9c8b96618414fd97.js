	...
	'week2' : {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"Lossy audio encoders aim to strip away undetectable components of a track. It works by dividing the music into a number of small frequency sub bands within the 20hz-20khz range. After carefully analyzing and examining properties of each band, any data deemed imperceivable is tossed. There's a lot to learn about lossy compression, like how unnoticable parts of a track are isolated (the short answer, is ",React.DOM.a( {target:"_blank", href:"http://nautil.us/blog/the-math-trick-behind-mp3s-jpegs-and-homer-simpsons-face"}, "fourier transforms"),"), but I can only tell you so much. One cool optimization that encodings such as MP3 make is called Mid/Side stereo. It mimics a left/right channel by maintaining a mid channel that contains the information that is identical on the left/right from the original source, and a side channel that "
				)
