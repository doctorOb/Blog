	...
	'week2' : {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"My friend ",React.DOM.a( {href:"https://twitter.com/kycayabyab"}, "Yubs"),", a fellow musician who frequently provides harmonica and spoken word accompanyments to my freestyle jams, came to visit last weekend to help me write lyrics for a track."
				),
