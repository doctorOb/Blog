	...
	'week2' : {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"Lossy audio encoders aim to strip away undetectable components of a track. It works by dividing the music into a number of small frequency sub bands within the 20hz-20khz range. After carefully analyzing and examining properties of each band any data deemed imperceivable is tossed."
				)
