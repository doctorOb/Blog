	...
	'week2' : {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"I went in to the studio to record the first track this week. I have recorded in a number of studios in the past, but have never dealt with the engineering behind it before. Professor Barton taught me a lot about optimal microphone placement, and how to layer two separate mic tracks together for a smooth balance. I'm currently using a Washburn Electric Acoustic guitar, so I have the option of using direct input. But I decided miking the guitar would be more intimate, and align better with the style I was going for, at least with the first song. The first microphone sits about 8 inches from the 12th fret of the guitar, while the second is angled towards the body. Idle ambient effects like that of fingers sliding up and down the neck, and the attack of the thumb when it plucks a note. These sounds help nourish a cozy intimate feeling, of an isolated personal performance, played solely towards the listener."
				),
