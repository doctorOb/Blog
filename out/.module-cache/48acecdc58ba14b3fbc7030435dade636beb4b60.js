	...
	render: function() {
		return (
			...
			React.DOM.h2( {className:"ui header"}, React.DOM.i( {className:"coffee icon"}),"The EP"),
				...
				React.DOM.figure( {name:"intro", className:"embed unloaded", 'data-iframe':"<iframe width=\"100%\" height=\"166\" scrolling=\"no\" frameborder=\"no\" src=\"https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/130688461undefined85undefinedfalseundefinedrk=true\"></iframe>"}
				),
				...
				React.DOM.figure( {name:"song1", className:"embed unloaded", 'data-iframe':"<iframe width=\"100%\" height=\"166\" scrolling=\"no\" frameborder=\"no\" src=\"https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/130688727undefined85undefinedfalseundefinedrk=true\"></iframe>"}
				),
