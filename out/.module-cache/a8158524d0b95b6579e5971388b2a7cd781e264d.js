	...
	'week2' : {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"I went in to the studio to record my first track this week. I have recorded in a number of studios in the past, but have never dealt with the engineering behind it before. Professor Barton taught me a lot about optimal microphone placement, and how to layer two separate mic tracks together for a smooth balance. I'm currently using a Washburn Electric Acoustic guitar, so I have the option of using direct input. But I decided miking the guitar would be more intimate, and align better with the style I was going for, at least with the my first song."
				)
