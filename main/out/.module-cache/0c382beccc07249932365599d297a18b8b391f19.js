	...
	'week3': {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					" Vocals weren't meant to be a core component of my EP. For my second track, I knew right away that I'd need something singing over most of the song, in order to make it eventful. "
				)
			)
		)
	},
