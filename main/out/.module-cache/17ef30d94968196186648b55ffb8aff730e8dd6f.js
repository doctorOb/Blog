	...
	'week3': {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"You can definitely notice how ",React.DOM.span( {className:"italic"}, "Pet Sounds")," influenced the album. Both share a mix of complex arrangements of esoteric auxiliary instruments, as well as the traditional and invigorating wall of sound. ",React.DOM.span( {className:"italic emphasis"}, "Within You Without You")," is perhaps my favorite track on the album. Composed solely by Harison, the eastern-inspired composition and daedal arrangement combine to cultivate a truly blissful five minutes of sound. This is where Martin's role as a music minded producer, who embraced theory and composed independently of any target instruments, came to light. Martin is a paragon for the ideals of this class, where the producer acts as an additional composer. "
				)
			)
		)
	},
