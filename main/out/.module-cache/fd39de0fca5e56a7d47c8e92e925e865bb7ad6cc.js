	...
	'week5' : {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"Acoustic guitarist know all to well of a curious, evanescent sound matching no known note produced by the guitar. Higher in pitch then a typical harmonic, and exponential in decay, the sound is a unmaskable byproduct of any diverse playing."
				)
