	...
	'week5' : {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"I started out with a high shelf filter. Shelving filters pass all frequencies through (rather then removing undesired ones, like cut filters), but increase or decrease frequencies below the shelf frequency."
				)
