	...
	'week3': {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"I've also set out to craft an ambient reprise track to insert between the second and final track. I got the idea after rewatching ",React.DOM.span( {className:"italic emphasis"}, "Upstream Color"),", which has a phenomenal soundtrack written by the film's writter/composer/editor/director, Shane Carruth"
				)
			)
		)
	},
