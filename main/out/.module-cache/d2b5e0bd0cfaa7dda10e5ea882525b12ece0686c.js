	...
	'week5' : {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"EQ is the meticulous process of manipulating the frequency of an audio source. It really is amazing just how much you can manipulate a track with EQ. Lets begin with a pretty recognizable example.",
