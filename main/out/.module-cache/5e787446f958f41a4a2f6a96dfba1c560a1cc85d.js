	...
	'week5' : {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"Let's begin with an example. Say you have a track that has some troubling overtones, resonating a dirty hum throughout your song. It isn't discordant, but its by no means pleasant. The presence of this ",
