	...
	'week4': {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"The second big component of Dubstep is the sub bass. A bass line is typically composed of sine waves. Typically two sine waves an octave apart, fed through a few filters and then distorted with EQ. "
				)
