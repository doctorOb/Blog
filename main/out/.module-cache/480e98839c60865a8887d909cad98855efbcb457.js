	...
	'week4': {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"I took the time to read up on miking Acoustic guitars. There are many ways to go about this, ranging from a single dynamic mic to a carefully positioned pairing of small condensers. "
				)
