...
(function($){
	$(document).ready(function(){
		...
		React.renderComponent(Blog( {body:articles['week2'].html, title:articles['week2'].title}), $('#2'));
		React.renderComponent(Blog( {body:articles['week1'].html, title:articles['week1'].title}), $('#1'));
