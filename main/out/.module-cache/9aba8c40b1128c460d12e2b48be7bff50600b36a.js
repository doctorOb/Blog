	...
	'week4': {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"But what about non traditional acoustic playing, such as finger style and classical? The outro of my second track, and the entirety of my third track, focus heavily on finger picking and intricate fretwork (hammer ons, pull offs, slides, and tapping). These nuances don't emenate from the hole like chords do, they start propagating from the fretboard, before anything is picked up and weakly refracted from the hole. Miking the neck thus becomes essential. For this reason, I use a split pairing: one large diaphragm condensor sufficiently spaced away from the neck, and one  "
				)
