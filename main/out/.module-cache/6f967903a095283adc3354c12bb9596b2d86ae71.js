	...
	'week3': {
		...
		html: (
			React.DOM.div(null, 
				...
				Quote( {text:"Portrait of a man who's emotions change the world around him. Afluent only in despair, a monotonous day job offers his only solace from the sorrowing thoughts that haunt him. I take you now to a bleak train ride through a weeping city, a solitary journey to and from work that cripples his hopes each day."} ),
				React.DOM.p(null, 
				...
				SubHeader( {text:"Second Lyric session: A Sit Down with Brie and Mike"} ),
				React.DOM.p(null
