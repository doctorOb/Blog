	...
	'week5' : {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"My own material has been completely dry of any EQ thus far. But with the bounty of readings assigned this week, all of which intimately cover equalization, I felt that now was the time to start. "
				)
