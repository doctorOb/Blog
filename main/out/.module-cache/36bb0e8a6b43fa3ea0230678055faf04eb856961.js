	...
	'week3': {
		...
		html: (
			React.DOM.div(null, 
				...
				Quote( {text:"Portrait of a man who's emotions change the world around him. Afluent only in despair, his monotonous day job offers his only solace from his thoughts. a bleak train ride to and from work offers his only moment of clarity."} )
			)
		)
	},
