	...
	'week3': {
		...
		html: (
			React.DOM.div(null, 
				...
				React.DOM.p(null, 
					"I'm fortunate enough to know a few of the many talented vocalists here at WPI. Two of them agreed to help me with lyrics and vocals for my second song. We sat down for an hour or so to come up with some lyrics. I explained the theme-wise continuation from my first track, and the overall flow of the song. We wrote lyrics for two back to back verses, and an interlude, before breaking it off for the day. Hopefully, we'll finish the lyrics up for this track by the end of the week. I plan to record most of the instrumentals before hand however."
				),

				React.DOM.p(null, 
					"Vocals weren't meant to be a core component of my EP. For my second track, I knew right away that I'd need someone singing over most of the song. For my other songs however, I have no desire for any dedicated vocals. I've already written a guitar line for what will likely become the last song on my album. I took a lot of inspiration from ",React.DOM.span( {className:"italic"}, "Elk")," by ",React.DOM.span( {className:"emphasis"}, "This Town Needs Guns (TTNG)"),"."
				),
				React.DOM.figure( {className:"embed unloaded", 'data-iframe':"<iframe style=\"border: 0; width: 100%; height: 142px;\" src=\"http://bandcamp.com/EmbeddedPlayer/album=990340459/size=large/bgcol=ffffff/linkcol=e99708/tracklist=false/artwork=small/t=7/transparent=true/\" seamless><a href=\"http://thistownneedsguns.bandcamp.com/album/animals\">Animals by TTNG</a></iframe>"}),React.DOM.figcaption(null, "I absolutely love the tapping in the guitar breaks"),
				React.DOM.p(null, 
					"I've written something with a similar energy level which I hope to finish composing this week. I'm looking for another instrument, perhaps a trumpet, to provide a melody on top of the guitar. The song will be an instrumental "
				)
			)
		)
	},
