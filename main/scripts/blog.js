...
(function($){
	$(document).ready(function(){
		...
		React.renderComponent(<SideBar/>,document.getElementById('sidenav'));
		React.renderComponent(<Blog body={articles['week5'].html} title={articles['week5'].title} name={articles['week5'].name}/>, $('#5')[0]);
