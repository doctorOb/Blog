	...
	'week2' : {
		...
		html: (
			<div>
				...
				<p>
					{"Now, while there may be a number of discernible audio artifacts generated during lossy encoding, it shouldn't be dismissed. The sheer demand for fast streaming audio means that providers can't afford the extra granularity of detail that uncompressed music gives. Right now, we're witnessing a re-popularization of uncompressed formats like FLAC. More providers are offering higher bit rate streams, that make the lossy listening experience a little bit better. I enjoy most of my music library on 256kbps mp3, and have nothing to complain over. "}<a href="http://bandcamp.com/">Bandcamp</a>{", a music purchase/streaming site for up and coming artists, offers a variety of compressed and uncompressed formats for any purchase you make. I highly recommend checking for an album there before pirating or purchasing through an alternate digital market."}
				</p>

				<SubHeader text={"First Lyric Session: A sit down with Yubs"}/>
				<p>
					{"My friend "}<a href="https://twitter.com/kycayabyab">Yubs</a>{", a fellow musician who frequently provides harmonica and spoken word accompaniments to my freestyle jams, came to visit last weekend to help me write lyrics for a track. This was my first real exercise in song writing. I've provided objective input for a singer's lyrics in the past, but never sat down to tell a real story through lyrics. We bounced ideas back and forth for a while, of what direction I wanted to take the album, what themes I wanted to cover, and differing approaches to present these themes."}
				</p>
